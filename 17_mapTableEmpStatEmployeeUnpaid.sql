-- Totals for the employment status, unpaid employee
...
where p2_membership <= 2
  and p5_age >= 12 
  and ( (p33_employment_status = 2 
           and (p32_activity_last_12_months = 2 or p32_activity_last_12_months = 4))
         or (p32_activity_last_12_months = 6 or p33_employment_status = 4));
...
drop table if exists censuswardLaborEmpStatEmployeeUnpaid;
create table censuswardLaborEmpStatEmployeeUnpaid as
