-- Totals for the occupation, machine operators 
/*
1 "Senior officials" 
2 "Professionals" 
3 "Technicians" 
...
where p2_membership <= 2
 and p34_occupation >= 811 and p34_occupation <= 834;
...
drop table if exists censuswardLaborOccMachine;
create table censuswardLaborOccMachine as
