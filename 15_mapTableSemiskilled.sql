-- Totals for the semi skilled population
...
where p2_membership <= 2
 and (p28_highest_level >=7 and p28_highest_level <= 13);
...
drop table if exists censuswardLaborSemiskilled;
create table censuswardLaborSemiskilled as
