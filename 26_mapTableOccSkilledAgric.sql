-- Totals for the occupation, skilled agric
/*
...
where p2_membership <= 2
 and p34_occupation >= 611 and p34_occupation <= 621;
...
drop table if exists censuswardLaborOccSkilledAgric;
create table censuswardLaborOccSkilledAgric as
