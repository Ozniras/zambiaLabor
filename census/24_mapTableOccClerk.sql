-- Totals for the occupation, clerk 
/*
...
where p2_membership <= 2
 and p34_occupation >= 411 and p34_occupation <= 422;
...
drop table if exists censuswardLaborOccClerks;
create table censuswardLaborOccClerks as
