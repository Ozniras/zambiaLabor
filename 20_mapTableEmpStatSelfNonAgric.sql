-- Totals for the employment status, self-employed non agric
...
drop table if exists censuswardLaborEmpStatSelfNonAgric;
create table censuswardLaborEmpStatSelfNonAgric as
