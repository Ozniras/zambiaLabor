-- Totals for the occupation, senior officials
/*
...
where p2_membership <= 2
 and p34_occupation >= 111 and p34_occupation <= 131;
...
drop table if exists censuswardLaborOccSeniorOfficials;
create table censuswardLaborOccSeniorOfficials as
