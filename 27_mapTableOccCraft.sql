-- Totals for the occupation, craft 
/*
1 "Senior officials" 
2 "Professionals" 
3 "Technicians" 
...
where p2_membership <= 2
 and p34_occupation >= 711 and p34_occupation <= 744;
...
drop table if exists censuswardLaborOccCraft;
create table censuswardLaborOccCraft as
