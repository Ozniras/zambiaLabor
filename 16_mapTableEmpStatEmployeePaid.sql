-- Totals for the employment status, paid employee
...
where p2_membership <= 2
  ...
  and (p32_activity_last_12_months = 1 or p32_activity_last_12_months = 3);
...
drop table if exists censuswardLaborEmpStatEmployeePaid;
create table censuswardLaborEmpStatEmployeePaid as
