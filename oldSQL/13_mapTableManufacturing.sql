...
where p2_membership <= 2
 and p35_industry >= 101 and p35_industry <= 332;
...
drop table if exists censuswardLaborManufacture;
create table censuswardLaborManufacture as
